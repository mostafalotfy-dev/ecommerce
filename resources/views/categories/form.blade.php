...
<div class="row">
    <div class="col-md-3">
        {{html()->label()->for("name_en")->class("required")->text(lang("models/category.fields.name_en"))}}
    ...
    <div class="col-md-3">
        {{html()->label()->for("name_ar")->class("required")->text(lang("models/category.fields.name_ar"))}}
